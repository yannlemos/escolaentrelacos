...
const autoOrient = ({ noAutoOrient }) => {
    // This is an opt out. We apply autoOrient by default.
    if (noAutoOrient === '' || noAutoOrient === 'true')
        return;
